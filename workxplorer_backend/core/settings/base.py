...
# --- Eskiz SMS ---
ESKIZ_BASE_URL = getenv("ESKIZ_BASE_URL", "https://notify.eskiz.uz")
ESKIZ_EMAIL = getenv("ESKIZ_EMAIL", "")
ESKIZ_PASSWORD = getenv("ESKIZ_PASSWORD", "")
ESKIZ_FROM = getenv("ESKIZ_FROM", "4546")
